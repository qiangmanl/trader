...
class MyStrategy(HistoricalStrategy):
    ...
    def start(self): 
        ...
        self.sell("SZ002212",1,islong=False)
        print(self.symbols.SZ002212.orderbook)
    def end(self):
    
        print(self.symbols.SZ002212.orderbook)
        from matplotlib import pyplot as plt
        plt.plot(self.symbols.SZ002212.orderbook.short_change)
        plt.show()
        plt.plot(self.symbols.SZ002212.orderbook.value)
        plt.show()
        import pdb
        pdb.set_trace()
#         # pdb.set_trace()
